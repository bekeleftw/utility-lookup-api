...
let otherSection = '';
if (util.other_providers && util.other_providers.length > 0) { otherSection = '<div class="up-other-providers"><div class="up-other-label">Other possible providers in this area</div><div class="up-other-list">' + util.other_providers.map(function(p) { return '<div class="up-other-chip"><span>' + icons[type] + '</span>' + p.name + '</div>'; }).join('') + '</div></div>'; }
