...
let otherSection = '';
if (util.other_providers && util.other_providers.length > 0) { otherSection = '<div class="up-other-providers"><div class="up-other-label up-other-toggle" data-card="' + cardId + '">Other possible providers <span class="up-other-caret">▼</span></div><div class="up-other-list up-other-collapsed" id="' + cardId + '-others">' + util.other_providers.map(function(p, i) { const altId = cardId + '-alt-' + i; let altDetails = ''; if (p.phone && p.phone !== 'NOT AVAILABLE') { altDetails += '<span style="margin-right:16px;font-size:12px;"><span style="color:#6b7280;">Phone</span> <a href="tel:' + p.phone + '" style="color:#7AC143;">' + p.phone + '</a></span>'; } if (p.website && p.website !== 'NOT AVAILABLE') { const wurl = p.website.startsWith('http') ? p.website : 'https://' + p.website; altDetails += '<span style="font-size:12px;"><span style="color:#6b7280;">Website</span> <a href="' + wurl + '" target="_blank" style="color:#7AC143;">Visit site</a></span>'; } return '<div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:8px;padding:12px;margin-bottom:10px;" id="' + altId + '"><div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px;"><div style="font-size:14px;font-weight:600;color:#1a1a1a;display:flex;align-items:center;gap:6px;"><span style="font-size:12px;">' + icons[type] + '</span>' + p.name + '</div><div style="display:flex;align-items:center;gap:6px;font-size:12px;color:#6b7280;"><span>Correct?</span><button class="up-alt-btn yes" data-alt-id="' + altId + '" data-provider="' + p.name + '" data-type="' + type + '" data-response="yes" style="padding:4px 12px;font-size:12px;border:1px solid #d1d5db;border-radius:4px;cursor:pointer;background:white;color:#374151;">Yes</button><button class="up-alt-btn no" data-alt-id="' + altId + '" data-provider="' + p.name + '" data-type="' + type + '" data-response="no" style="padding:4px 12px;font-size:12px;border:1px solid #d1d5db;border-radius:4px;cursor:pointer;background:white;color:#374151;">No</button><span class="up-alt-done" id="' + altId + '-done" style="display:none;color:#7AC143;font-size:12px;">Thanks!</span></div></div>' + (altDetails ? '<div style="margin-top:8px;padding-top:8px;border-top:1px solid #e5e7eb;">' + altDetails + '</div>' : '') + '</div>'; }).join('') + '</div></div>'; }
