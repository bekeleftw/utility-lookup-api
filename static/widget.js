...
let otherSection = '';
if (util.other_providers && util.other_providers.length > 0) { otherSection = '<div class="up-other-providers"><div class="up-other-label up-other-toggle" data-card="' + cardId + '">Other possible providers <span class="up-other-caret">▼</span></div><div class="up-other-list up-other-collapsed" id="' + cardId + '-others">' + util.other_providers.map(function(p, i) { const altId = cardId + '-alt-' + i; return '<div class="up-other-item" id="' + altId + '"><div class="up-other-chip"><span>' + icons[type] + '</span>' + p.name + '</div><div class="up-other-feedback"><span>Correct?</span><button class="up-alt-btn yes" data-alt-id="' + altId + '" data-provider="' + p.name + '" data-type="' + type + '" data-response="yes">Yes</button><button class="up-alt-btn no" data-alt-id="' + altId + '" data-provider="' + p.name + '" data-type="' + type + '" data-response="no">No</button><span class="up-alt-done" id="' + altId + '-done">Thanks!</span></div></div>'; }).join('') + '</div></div>'; }
