...
UTILITY_ALIASES = {
    ...
    'dominion': ['dominion', 'dominion energy', 'dominion energy virginia'],
    'xcel': ['xcel', 'xcel energy'],
    'entergy': ['entergy', 'entergy louisiana', 'entergy texas'],
    'aep': ['aep', 'american electric power', 'aep texas'],
    'peco': ['peco', 'peco energy'],
    'pseg': ['pseg', 'public service electric and gas', 'public service enterprise group'],
    'national grid': ['national grid', 'nationalgrid'],
    'eversource': ['eversource', 'eversource energy'],
